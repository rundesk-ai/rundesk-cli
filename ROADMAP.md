...
`MEMORY.md` — copied with one substitution (`{agent}`, `agent.py:39`) and never text built in
...
[`write-a-provider-adapter.md`](docs/extending/provider-adapters/references/the-contract.md), and the closed vocabularies
