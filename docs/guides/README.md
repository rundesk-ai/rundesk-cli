...
One task each, start to finish, with the failures that interrupt it.

| Page | Task |
|---|---|
| [getting-started.md](./getting-started.md) | Install Rundesk and set up your first agent |
| [managing-an-install.md](./managing-an-install.md) | Check, update, back up and troubleshoot an install |
