...
# reaching it
rundesk ask [--provider <provider>] [--model <model>] [--set <key=value>] [--conversation <conversation>] [--fresh] [--read-only] [--steer] [--says <text>] <agent> <prompt>   one turn, streamed to this terminal
