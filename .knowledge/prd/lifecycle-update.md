...
| ✅ | R-UPD-42 | The machine queues one automatic Rundesk update every day at three in the morning | `the daily trigger runs at three in the morning`, `the daily trigger queues the crash recoverable worker`, `installing schedules daily updates for three in the morning` |
