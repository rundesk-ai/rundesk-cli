...
| ✅ | R-UPD-48 | A section a release adds reaches a configuration written before it existed, and nothing already stated is touched | `a section this release added reaches a file written before it`, `a value already stated survives the section being added`, `a configuration that cannot be read is left exactly as it is` |
