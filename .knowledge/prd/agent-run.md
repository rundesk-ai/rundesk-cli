...
| ✅ | R-RUN-22 | What brains printed longer ago than the kept window is swept, and every account still reads | `what a brain printed longer ago than the window is swept`, `sweeping what a brain printed leaves every account readable`, `sweeping where nothing was ever printed is ordinary` |
