...
| ❌ | R-PRV-20 | A brain says when it made a file, rather than a reader guessing from what a tool printed | src/rundesk/turn.py:78 — the record is carried and the shipped adapter reports it; no test drives a brain that makes one |
...
| ❌ | R-PRV-22 | A brain says whether what it just said is finished or still being written | src/rundesk/provider.py:60 — the shipped adapter reports it and a surface acts on it; no test drives a brain that streams fragments |
