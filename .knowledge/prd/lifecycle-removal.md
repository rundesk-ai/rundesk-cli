...
| ✅ | R-RM-8 | Removing rundesk takes the directory the install created once nothing of the owner's is left in it | `removing an install the installer made takes its directory`, `purging takes what the gateways wrote as well` |
