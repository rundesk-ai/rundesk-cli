...
| ✅ | R-AGW-5 | Taking an agent away keeps the account of what it did until a removal is asked for that too | `taking an agent away keeps the account of what it did`, `taking an agent away keeps what its schedules did`, `a removal asked for the account too takes it` |
