...
| ✅ | R-INS-13 | Everything rundesk's install is made of lives in one directory under the person's home, kept apart from what the owner keeps | `the install lives under the persons home`, `an install writes nothing outside the places it says` |
