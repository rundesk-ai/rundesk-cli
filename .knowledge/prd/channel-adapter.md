...
| ✅ | R-CAD-20 | A value this install keeps is never given to an adapter under the name that adapter reads its own credential from (R-SEC-29) | `a surface is never given the value it reads its own credential from` |
