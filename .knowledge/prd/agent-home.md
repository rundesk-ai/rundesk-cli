...
| ✅ | R-AGT-35 | A built-in a release renames is taken out of the library, and an agent holding it holds the new name instead | `every rename names a skill this release ships`, `a renamed built in is taken out of the library`, `a grant of a renamed built in becomes a grant of the new name`, `a rename never hands the new skill to an agent without the old`, `a skill the owner wrote under the old name is never retired`, `a skill the owner wrote under the new name is not the rename landing`, `nothing is carried until the new name is in the library`, `no shipped instruction names a skill this release retired`, `uninstalling takes a renamed built in too`, `a built in this release dropped is taken out of the library`, `a grant of a dropped built in is taken away rather than left pointing at nothing`, `laying down also retires what this release renamed` |
