...
| ✅ | R-AGT-40 | A new agent keeps personal facts and response preferences in memory rather than a separate page | `a new home has no separate user page`, `a legacy user override does not restore the retired page` |
