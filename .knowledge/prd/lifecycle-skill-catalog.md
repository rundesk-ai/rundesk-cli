...
| ✅ | R-CAT-6 | A retired built-in skill can move to catalog ownership without breaking its grants | `a retired built in is adopted without breaking its grant`, `development guidance is not a rundesk built in` |
