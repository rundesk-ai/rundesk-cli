...
| ✅ | R-GW-8 | The gateway going away ends every program it was running (R-PROC-5) | `a gateway going away ends what it was running`, `work that starts as the gateway goes away is not left running`, `being asked to stop twice does not kill it mid shutdown`, `one gateway ending its work leaves another gateways work alone` |
