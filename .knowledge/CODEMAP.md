...
| `test_catalog.py` | 25 | `lifecycle-skill-catalog` — manifests, provenance, default seeding, lifecycle refresh, ownership, atomic updates, removal, and unsafe archives, all offline |
